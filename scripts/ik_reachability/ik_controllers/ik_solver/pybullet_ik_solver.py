...
_HUMAN_CFG = {
    ...
    "left": {
        "j1": ( 0.000,  0.15,  -1.500,  1.396),
        "j2": ( 0.700,  0.20,   0.000,  1.600),
        "j3": ( 0.000,  0.60,  -0.000,  1.571),  # LEFT: j3 mirrored
        "j4": ( 1.5708, 0.05,   0.250,  2.200),
        "j5": ( 0.000,  0.02,  -1.571,  1.571),
        "j6": ( 0.000,  0.02,  -0.785,  0.785),
        "j7": ( 0.000,  0.04,  -1.571,  1.571),
    },
}
