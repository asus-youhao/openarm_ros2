...
_HUMAN_CFG = {
    ...
    "left": {
        ...
        # URDF limits: j1[-200°,+80°]  j2[-190°,+10°]  j7 axis=0 -1 0 (mirrored)
        "j1": ( 0.000,  0.15,  -3.491,  1.396),  # URDF: lo=-200°=-3.491, hi=+80°=+1.396
        "j2": (-0.700,  0.20,  -3.316,  0.175),  # pref=-0.7! URDF: lo=-190°=-3.316, hi=+10°=+0.175
        "j3": ( 0.000,  0.60,  -1.571,  1.571),  # URDF: [-90°,+90°] full range
        "j4": ( 1.5708, 0.05,   0.000,  2.444),  # URDF: [0°,+140°]
        "j5": ( 0.000,  0.02,  -1.571,  1.571),  # forearm roll: neutral
