...
_HUMAN_LEFT = [
#                pref    soft_lo  soft_hi  hard_lo  hard_hi  weight   name
    ( 0.000, -1.300,   0.300,  -3.491,   1.396,   2.5),  # j1 shoulder-yaw  URDF[-200°,+80°]  大馬達
    (-0.700, -1.600,   0.000,  -3.316,   0.175,   4.0),  # j2 shoulder-pitch  pref=-0.7 (MIRROR of right +0.7)  URDF[-190°,+10°]  大馬達
    ( 0.000, -1.571,   0.300,  -1.571,   1.571,  10.0),  # j3 upperarm-yaw  j3=0=forward  URDF[-90°,+90°]  大馬達
    ( 1.5708, 0.250,   2.200,   0.000,   2.444,   2.0),  # j4 elbow-flex 90°  URDF[0°,140°]
    ( 0.000, -1.571,   1.571,  -1.571,   1.571,   0.8),  # j5 forearm-roll
    ( 0.000, -0.785,   0.785,  -0.785,   0.785,   0.8),  # j6 wrist-yaw
