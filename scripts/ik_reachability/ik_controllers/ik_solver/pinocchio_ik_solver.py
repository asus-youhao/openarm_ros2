...
_HUMAN_LEFT = [
    ( 0.000, -1.000,   0.400,  -1.500,   1.396,   2.5),
    ( 0.700,  0.000,   1.600,   0.000,   1.600,   4.0),
    ( 0.000,  0.000,   1.571,   0.000,   1.571,  10.0),  # LEFT: j3=0=forward mirrored, hard_hi=1.571
    ( 1.5708, 0.250,   2.200,   0.250,   2.200,   2.0),
    ( 0.000, -1.571,   1.571,  -1.571,   1.571,   0.8),
    ( 0.000, -0.785,   0.785,  -0.785,   0.785,   0.8),
    ( 0.000, -1.571,   1.571,  -1.571,   1.571,   0.5),
]
