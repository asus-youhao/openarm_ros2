...
_RIGHT_CFG: List[JointCfg] = [
    ...
    JointCfg( 0.0000, -0.4000,  0.9000, -1.3963,  1.5000, 3.0, "j1_shoulder_yaw"),
    JointCfg( 0.7000,  0.0000,  1.5000,  0.0000,  1.6000, 4.0, "j2_shoulder_pitch_pref=0.7"),
...
# ── Left Arm (mirrored — j2 convention is OPPOSITE to right) ─────────────────
...
_SEEDS_LEFT: List[List[float]] = [
    ...
    [ 0.0000, -0.7000,  0.0000,  1.5708,  0.0000,  0.0000,  0.0000],  # forward-reach home 90°
    [ 0.0000, -1.0000,  0.0000,  1.5708,  0.0000,  0.0000,  0.0000],  # shoulder higher
    [ 0.0000, -0.5000,  0.0000,  1.5708,  0.0000,  0.0000,  0.0000],  # shoulder lower
    [-0.2000, -0.7000,  0.2000,  1.5708,  0.0000,  0.0000,  0.0000],  # j1 inward
    [ 0.2000, -0.7000,  0.2000,  1.5708,  0.0000,  0.0000,  0.0000],  # j1 outward
    [ 0.0000, -0.8000,  0.0000,  2.0000,  0.0000,  0.0000,  0.0000],  # elbow ~115°
    [ 0.0000, -1.0000,  0.3000,  1.5708,  0.0000, -0.3000,  0.0000],  # reach-up
    [-0.3000, -0.7000,  0.2000,  1.5708,  0.0000,  0.0000,  0.0000],  # j1 far inward
    [ 0.3000, -0.7000,  0.2000,  1.5708,  0.0000,  0.0000,  0.0000],  # j1 far outward
    [ 0.0000, -0.9000,  0.0000,  2.0000,  0.0000,  0.0000,  0.0000],  # deep reach
]
